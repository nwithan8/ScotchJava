...
public class HttpUrlConnectionTest {
    ...
    public void testClient() throws IOException {
        RecordableHttpsURLConnection connection = TestUtils.getSimpleHttpsURLConnection("https://www.google.com", "test_client", Mode.Bypass);
    ...
    public void testErase() throws Exception {
        ...
        FakeDataService.Post[] posts = GetPostsRequest(cassette, Mode.Record);
    ...
    public void testEraseAndPlayback()
    {
        ...
        Assert.assertThrows(Exception.class, () -> GetPostsRequest(cassette, Mode.Replay));
    }
    ...
    public void testAutoMode() throws Exception {
        ...
        FakeDataService.Post[] posts = GetPostsRequest(cassette, Mode.Auto);
        Assert.assertNotNull(posts);
    ...
    public void testInteractionElements() throws Exception {
        ...
        RecordableHttpsURLConnection connection =
                (RecordableHttpsURLConnection) HttpClients.newClient(HttpClientType.HttpsUrlConnection, FakeDataService.GET_POSTS_URL, cassette, Mode.Record);
        FakeDataService.HttpsUrlConnection fakeDataService = new FakeDataService.HttpsUrlConnection(connection);
    ...
    public void testCensors() throws Exception {
        ...
        RecordableHttpsURLConnection connection =
                (RecordableHttpsURLConnection) HttpClients.newClient(HttpClientType.HttpsUrlConnection, FakeDataService.GET_POSTS_URL, cassette, Mode.Record, advancedSettings);
        FakeDataService.HttpsUrlConnection fakeDataService = new FakeDataService.HttpsUrlConnection(connection);
        var ignore = fakeDataService.getPostsRawResponse();

        // now replay cassette
        connection =
                (RecordableHttpsURLConnection) HttpClients.newClient(HttpClientType.HttpsUrlConnection, FakeDataService.GET_POSTS_URL, cassette, Mode.Replay, advancedSettings);
    ...
    public void testMatchSettings() throws Exception {
        ...
        connection =
                (RecordableHttpsURLConnection) HttpClients.newClient(HttpClientType.HttpsUrlConnection, FakeDataService.GET_POSTS_URL, cassette, Mode.Replay);
        connection.setRequestProperty("X-Custom-Header", "custom-value"); // add custom header to request, shouldn't matter when matching by default rules
        fakeDataService = new FakeDataService.HttpsUrlConnection(connection);
        RecordableHttpsURLConnection response = (RecordableHttpsURLConnection) fakeDataService.getPostsRawResponse();
        Assert.assertNotNull(response);
        ...
        connection =
                (RecordableHttpsURLConnection) HttpClients.newClient(HttpClientType.HttpsUrlConnection, FakeDataService.GET_POSTS_URL, cassette, Mode.Replay, advancedSettings);
        connection.setRequestProperty("X-Custom-Header", "custom-value"); // add custom header to request, causing a match failure when matching by everything
        fakeDataService = new FakeDataService.HttpsUrlConnection(connection);
    ...
    public void testDelay() throws Exception {
        ...
        RecordableHttpsURLConnection connection =
                (RecordableHttpsURLConnection) HttpClients.newClient(HttpClientType.HttpsUrlConnection, FakeDataService.GET_POSTS_URL, cassette, Mode.Record);
        FakeDataService.HttpsUrlConnection fakeDataService = new FakeDataService.HttpsUrlConnection(connection);
        var ignore = fakeDataService.getPosts();
