...
public abstract class VCRHttpRequest extends HttpRequest {
     ...
     *                                  parameters)
     * @apiNote The following scenarios demonstrate typical use-cases of the filter.
     ...
     * @since 16
     */
    public static VCRHttpRequest.Builder newVCRBuilder(VCRHttpRequest request, BiPredicate<String, String> filter,
                                                       VCR vcr) {
    ...
    public interface Builder {
         ...
         * @return this builder
         */
        public VCRHttpRequest.Builder POST(VCRHttpRequest.BodyPublisher bodyPublisher);
         ...
         * @return this builder
         */
        public VCRHttpRequest.Builder PUT(VCRHttpRequest.BodyPublisher bodyPublisher);
