...
public class VCRHttpHeadersBuilder {

    private final TreeMap<String, List<String>> headersMap;

    public VCRHttpHeadersBuilder() {
        headersMap = new TreeMap<>(String.CASE_INSENSITIVE_ORDER);
    }

    public VCRHttpHeadersBuilder structuralCopy() {
        VCRHttpHeadersBuilder builder = new VCRHttpHeadersBuilder();
